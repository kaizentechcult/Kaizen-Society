...
export function getTechnologyColor(name: string, theme: string) {
  switch (name.toLowerCase()) {
    ...
    default: return theme === 'dark' ? 'text-zinc-400' : 'text-gray-400';
  }
}
        ...
        <div className="min-w-0">
          <div className="flex flex-wrap items-center gap-2 mb-1.5">
            ...
            <div className={`flex items-center gap-1.5 px-2 py-0.5 rounded-md text-sm font-medium ${
              ...
              <span className={getTechnologyColor(problem.topic, theme)}>Topic:</span>
